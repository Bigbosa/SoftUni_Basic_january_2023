...
if route_type == "cross-country" and total_cyclists >= 50:
    junior_total = (tournament_info["juniors"][route_type] - (tournament_info["juniors"][route_type]) * tournament_info["juniors"]["off"]) * cyclists_juniors
    seniors_total = (tournament_info["seniors"][route_type] - (tournament_info["seniors"][route_type]) * tournament_info["juniors"]["off"]) * cyclists_seniors
